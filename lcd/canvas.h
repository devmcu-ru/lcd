...
typedef void (*CanvasScanCircleCallback)(
  Canvas* c,
  int y,
  int x1,
  int x2,
...
void    canvas_scan_circle(Canvas* canvas, int xc, int yc, int r, CanvasScanCircleCallback callback, void* param);
void    canvas_fill_circle(Canvas* canvas, int xc, int yx, int r);
